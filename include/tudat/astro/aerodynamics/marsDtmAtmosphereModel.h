...
namespace aerodynamics
{
    ...
    static std::vector<marsDate> marsYears = {
            ...
            marsDate(2030, 7, 5 , 0, 0, 0),
        marsDate(2032, 5, 22 , 0, 0, 0),
            marsDate(2034, 4, 9 , 0, 0, 0),
            marsDate(2036, 2, 25 , 0, 0, 0),
            marsDate(2038, 1, 12 , 0, 0, 0),
            marsDate(2039, 11, 30 , 0, 0, 0),
            marsDate(2041, 10, 17 , 0, 0, 0),
            marsDate(2043, 9, 4 , 0, 0, 0),
            marsDate(2045, 7, 22 , 0, 0, 0),
            marsDate(2047, 6, 9 , 0, 0, 0),
            marsDate(2049, 4, 26 , 0, 0, 0),
            marsDate(2051, 3, 13 , 0, 0, 0),
            marsDate(2053, 1,28 ,   0,   0 ,   0 ),
            marsDate(2054,12 ,16 ,   0 ,   0 ,   0 ),
            marsDate(2056 ,11 ,2 ,   0 ,   0 ,   0 ),
            marsDate(2058 ,9 ,20 ,   0 ,   0 ,   0 ),
            marsDate(2060 ,8 ,7 ,   0 ,   0 ,   0 ),
            marsDate(2062 ,6 ,25 ,   0 ,0 ,0 ),
        marsDate(2064,5,12,0,0,0),
            marsDate(2066,3,30,0,0,0),
            marsDate(2068,2,15,0,0,0),
            marsDate(2070,1,2,0,0,0),
            marsDate(2071,11,20,0,0,0),
            marsDate(2073,10,7,0,0,0),
            marsDate(2075,8,25,0,0,0),
            marsDate(2077,7,12,0,0,0),
            marsDate(2079,5,30,0,0,0),
            marsDate(2081,4,16 ,  0 ,  0 ,  0 ),
            marsDate(2083 ,3 ,4 ,  0 ,  0 ,  0 ),
            marsDate(2085 ,1 ,19 ,  0 ,  0 ,  0 ),
            marsDate(2086 ,12 ,7 ,  0 ,  0 ,  0 ),
            marsDate(2088 ,10 ,24 ,  0 ,   0 ,   0 ),
            marsDate(2090 ,9 ,11 ,   0 ,   0 ,   0 ),
            marsDate(2092 ,7 ,29 ,   0 ,   0 ,   0 ),
            marsDate(2094 ,6 ,16 ,   0 ,   0 ,   0 ),
            marsDate(2096 ,5 ,3 ,   0 ,   0 ,   0 )
    };
