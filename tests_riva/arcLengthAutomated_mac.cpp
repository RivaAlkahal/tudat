...
void arcLengthRuns( double hoursperday, double initialTime, double finalTime, int arcLength, int iterationNumber, double perturbPos, double perturbVel, int number_of_arcs, int itotalDuration, int startTime, int intperturbPos, int intperturbVel )
{
    ...
    std::string fileTag = "arcLengths_" +  std::to_string(arcLength) + std::to_string(itotalDuration) +  "darc_startat" + std::to_string(startTime)
                          + "_" + std::to_string(intperturbPos) + "perpos_" + std::to_string(intperturbVel) + "_pervel_" + std::to_string(hoursperday) + "hobs_" + std::to_string(iterationNumber) + "itr" ;
...
int main() {
        ...
        double finalTime = 86400.0;
        int arcLength = 1;
        int iterationNumber = 3;
        double perturbPos = 1000;
        double perturbVel = 0.001;
        int number_of_arcs = 1;
        int itotalDuration= 1;
        int startTime = 0;
        int intperturbPos = 1000;
        int intperturbVel =0001;
        arcLengthRuns( hoursperday,  initialTime,  finalTime, arcLength,  iterationNumber, perturbPos, perturbVel, number_of_arcs,  itotalDuration,  startTime,  intperturbPos,  intperturbVel );
