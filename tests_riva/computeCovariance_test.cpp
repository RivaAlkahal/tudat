...
int main(int argc, char* argv[])
{
    ...
    std::string fileTag = "accumul_InverseAprALLGlobalPars_drag_5" + std::to_string(itotalDuration);
    int used = loadArcResultsRange(baseDir,numArcs,&numberOfLocalParametersAll, &normalizedDesignMatrices,&unnormalizedDesignMatrices,&normalizationFactors,&weightDiagonals,&P0_matrices);
