//
// Created by ralkahal on 31-1-25.
//
//
...
void arcLengthRuns( double hoursperday, double initialTime, double finalTime, int arcLength, int iterationNumber, double perturbPos, double perturbVel, int number_of_arcs, int itotalDuration, int startTime, int intperturbPos, int intperturbVel, int ihoursperday, bool performEst )
{
    ...
    std::string saveDirectory = "/home/ralkahal/nnew-tudat-tests/covAn/twowaydoppler_apriori/longertimes/";    //std::string fileTag = "arcLengths_160darc_startat320_0per_10hobs_6itr";
    std::string fileTag = "noapr23410poly_aprperiodicand18StaticandDragperarc_" +  std::to_string(arcLength) + std::to_string(itotalDuration) +  "darc_startat" + std::to_string(startTime)
...
int main() {
        ...
        std::vector<int> number_of_arcs= {356};//137, 210, 283};
        ...
        std::vector<int> totalDuration = {1780};
        std::vector<double> finalTimes= {86400.0*1780.0};//,86400.0*1050.0,86400.0*1415.0};
