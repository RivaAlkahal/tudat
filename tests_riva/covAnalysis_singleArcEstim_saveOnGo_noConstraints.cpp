//
// Created by ralkahal on 10-6-25.
//
//
...
std::string saveDirectory = "/home/ralkahal/nnew-tudat-tests/covAn/twowaydoppler_apriori/accumsResults_CS_woConstrains/";
...
int main() {
	...
	int batchSize = 365;
        ...
        std::vector<int> number_of_arcs= {3650};//72,137,210};//{210,283,356};
        ...
        std::vector<int> totalDuration = {18250};//360};//,685,1050}; //{1050,1415,1780};
        std::vector<double> finalTimes= {86400.0*18250.0};//,//,86400.0*685.0,86400.0*1050.0}; //{86400.0*1050.0,86400.0*1415.0,86400.0*1780.0};
