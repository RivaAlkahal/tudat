...
void arcLengthRuns( double hoursperday, double initialTime, double finalTime, int arcLength, int iterationNumber, double perturbPos, double perturbVel, int number_of_arcs, int itotalDuration, int startTime, int intperturbPos, int intperturbVel, int ihoursperday, bool performEst )
{
    ...
    std::string saveDirectory = "/home/ralkahal/nnew-tudat-tests/covAn/twowaydoppler_apriori/manualSetupTest/";    //std::string fileTag = "arcLengths_160darc_startat320_0per_10hobs_6itr";
    ...
    std::string fileTag = "staticC20DEBUGDragperarc_" +  std::to_string(arcLength) + std::to_string(itotalDuration) +  "darc_startat" + std::to_string(startTime)
        + "_" + std::to_string(finalTime) + "_" + std::to_string(intperturbPos) + "perpos_" + std::to_string(intperturbVel) + "_pervel_" + std::to_string(ihoursperday) + "hobs_" + std::to_string(iterationNumber) + "itr_spiceprop" ;
...
int main() {
        ...
        std::vector<int> number_of_arcs= {72,137,210};
        ...
        std::vector<int> totalDuration = {360,685,1050};
        std::vector<double> finalTimes= {86400.0*360.0,86400.0*1050.0};
