...
int main( ) {
        ...
        std::string fileTag = "arcLengths_360darc_startat360_1000perpos-001-10obs_6itr";

        bool performEstimation = false;
        // set input options
        ...
        Time initialEphemerisTime = Time( 86400.0 * 360 ) ;
        Time finalEphemerisTime = Time( 86400.0 * 360 + 86400.0 * 60.0 ); // 5 years later
        ...
        {
                initialParameterEstimate[ 0 + 6 * i ] += 1000.0E0;
                initialParameterEstimate[ 1 + 6 * i ] += 1000.0E0;
                initialParameterEstimate[ 2 + 6 * i ] += 1000.0E0;
                initialParameterEstimate[ 3 + 6 * i ] += 0.01;
                initialParameterEstimate[ 4 + 6 * i ] += 0.01;
                initialParameterEstimate[ 5 + 6 * i ] += 0.01;
        }
